...
class Presenter {
    ...
    private let subscribeOn: SubscribeOn
    private let observeOn: ObserveOn
    internal let uiDomain: UIDomain
    private var subscriptions: CompositeDisposable
    
    init(wireframe: Wireframe, uiDomain: UIDomain, subscribeOn: SubscribeOn, observeOn: ObserveOn) {
        self.wireframe = wireframe
        self.uiDomain = uiDomain
        self.subscribeOn = subscribeOn

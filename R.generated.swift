...
struct _R: Rswift.Validatable {
  static let hostingBundle = NSBundle(identifier: "com.refineriaweb.base-app-ios")
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if _R.storyboard.main().viewController() == nil { throw ValidationError(description:"[R.swift] ViewController with identifier 'viewController' could not be loaded from storyboard 'Main' as 'ViewController'.") }
      }
      
      func viewController() -> ViewController? {
        return UIStoryboard(resource: self).instantiateViewControllerWithIdentifier("ViewController") as? ViewController
      }
    }
